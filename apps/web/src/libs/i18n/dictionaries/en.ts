export const en = {
	...
	briefs: {
		...
		detail: {
			...
			aiDisclosure:
				"Generated by AI. This brief is written by a language model and voiced by a speech model, from the press articles it cites. No human reviews it before it is published.",
